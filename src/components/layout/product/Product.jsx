...
export function Product() {
    ...
    function handleClickWhatsapp() {
        enqueueSnackbar('Teremos um whatsapp em breve!', { variant: "warning" });
    }

    return (
        <Container className="container max-w-full mt-2" id="product">

            <div className="bg-gradient-to-b">
                <div className="container m-auto px-6 py-10 md:px-12 lg:px-20">

                    {/* Title */}
                    <div className="m-auto h-30 md:h-25 text-center lg:w-8/12 xl:w-7/12">
                        <h2 id="title" className="text-3xl text-white font-bold md:text-4xl">Decore sua casa com <span className='text-orange-400'>artes digitais</span> impressas em material de alta qualidade!</h2>
                    </div>
